        ...
        <el-menu :default-openeds="['1','2']" background-color="#1c213f" text-color="#fff">
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="1-3" v-if="isSupper" @click="userCreate">创建用户</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="2">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="2-4" @click="algorithmOffline">离线运行</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </el-aside>
...
export default {
  ...
  methods: {
    ...
    algorithmOffline() {
      this.$router.push({name: "AlgorithmOffline"});
    },
    datasetInfo() {
